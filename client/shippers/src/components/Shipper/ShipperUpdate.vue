<template>
    ...
    <div class="shipper-create-form">
        ...
        <input type="text" placeholder="" v-model.lazy="formData.company_name" /> <br>
        ...
        <button @click="updateShipper"> Update Shipper </button> <br>
...
const headerTitle = 'Update Shipper';
</script>
...
export default {
    ...
    methods: {
        ...
        updateShipper(){
            ...
            return this.$axios.patch(`api/shippers/${this.shipperId}/update`, this.formData)
                        .then(response => {
    ...
    beforeMount() {
        this.$axios.get(`api/shippers/${this.shipperId}/show`)
                    .then(response => {
                        const shipper = response.data.data
                        if(shipper){
                            this.formData.company_name = shipper.company_name;
                            this.formData.address = shipper.address;
                            if (shipper.primary_contact) {
                                this.formData.contact.name = shipper.primary_contact.name;
                                this.formData.contact.contact_number = shipper.primary_contact.contact_number;
                            }
                        }
                    })
                    .catch(e => {
